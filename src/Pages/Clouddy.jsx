    ...
    return (
        <div className='app'>
            ...
            <div className="instruction-container">
                <h1>Como fazer o primeiro acesso no ClouDDy Media Player</h1>
                <p>Seja bem-vindo ao guia de primeiro acesso ao ClouDDy Media Player. Aqui estão os passos para você começar:</p>

                <div className="instruction-step">
                    <h2>Passo 1: Baixe o aplicativo</h2>
                    <p>Você pode baixar o aplicativo ClouDDy Media Player na loja de aplicativos do seu dispositivo.</p>
                </div>
                ...
                <div className="instruction-step">
                    ...
                    <p>Agora você pode começar a assistir ao seu conteúdo favorito no ClouDDy Media Player.</p>
                </div>
